 ...
 *   packages/api-contract/src/catalog-taxonomy.json shared catalog taxonomy
...
const catalogTaxonomy = JSON.parse(readFileSync(join(ROOT, 'packages/api-contract/src/catalog-taxonomy.json'), 'utf8'));
...
${Object.entries(t.icon.sizes)
  ...
  --sw-category-columns: 3;
  --sw-category-width: calc(100% / 3 - 16rpx);
...
`
  ...
  --sw-category-columns: ${s.categoryColumns};
  --sw-category-width: calc(100% / ${s.categoryColumns} - 16rpx);
...
const catalogModule = `/* GENERATED by scripts/build-miniapp-assets.mjs — do not edit by hand. */
/* Source: packages/api-contract/src/catalog-taxonomy.json v${catalogTaxonomy.version}. */
module.exports = ${JSON.stringify(catalogTaxonomy, null, 2)};
`;
...
const outputs = {
  ...
  'data/catalog-taxonomy.generated.js': catalogModule,
};
