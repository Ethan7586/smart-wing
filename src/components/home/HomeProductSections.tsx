...
export const HomeProductSections: React.FC = () => {
  ...
  const categories = [
    { id: 'cat_food', title: '食品饮料与粮油', detail: '米面粮油 · 茶饮零食', tone: 'text-emerald-600', tag: '餐卡可用' },
    { id: 'cat_appliance', title: '家用电器', detail: '厨房小电 · 生活电器', tone: 'text-blue-600', tag: '家庭焕新' },
    ...
    <>
      ...
      <div className="max-w-[1280px] mx-auto px-4">
        <div className="rounded-md border border-dashed border-blue-200 bg-blue-50/50 p-4 flex gap-3 text-xs text-gray-600">
          ...
          <p><strong className="text-gray-900">服务类货盘接入中：</strong>电影票、虚拟卡券、附近门店核销将在供应商接口和履约规则确认后单独开放，当前不展示空商品位。</p>
        </div>
      </div>
