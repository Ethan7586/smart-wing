...
export async function handleAfterSales(
  request: Request,
  env: WorkerEnv,
  actor: Actor,
  requestId: string
...
export async function handleCreateAfterSale(
  request: Request,
  env: WorkerEnv,
  actor: Actor,
  requestId: string
...
export async function handleCreateOrder(
  ...
  const recipientCipher = await encryptJson(
    input.recipient,
...
export async function handleInternalPayment(
  request: Request,
  env: WorkerEnv,
  actor: Actor,
  orderId: string,
