...
const KNOWN_ERRORS = [
  ...
  ['MALL_APPLICATION_NOT_FOUND', 404, 'MALL_APPLICATION_NOT_FOUND', '商城应用不存在或不在当前管理范围'],
  ['MALL_APPLICATION_HISTORY_NOT_FOUND', 404, 'MALL_APPLICATION_HISTORY_NOT_FOUND', '商城历史版本不存在'],
  ['MALL_APPLICATION_VERSION_CONFLICT', 409, 'MALL_APPLICATION_VERSION_CONFLICT', '商城配置已被其他管理员修改，请刷新后重试'],
  ['MALL_APPLICATION_CODE_OR_SLUG_CONFLICT', 409, 'MALL_APPLICATION_CODE_OR_SLUG_CONFLICT', '商城编码或访问标识已存在'],
  ['MALL_APPLICATION_SCOPE_FORBIDDEN', 403, 'MALL_APPLICATION_SCOPE_FORBIDDEN', '当前身份无权管理该商城'],
  ['MALL_APPLICATION_REASON_REQUIRED', 422, 'MALL_APPLICATION_REASON_REQUIRED', '必须填写至少四个字的变更原因'],
  ['MALL_APPLICATION_ACTION_INVALID', 422, 'MALL_APPLICATION_ACTION_INVALID', '商城操作类型无效'],
